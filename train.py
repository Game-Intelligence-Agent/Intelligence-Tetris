...
def main():
    ...
    name = args.train_hyper['model_params']['model_name'] + '_' + args.train_hyper['model_params']['model_type'] + '_' + args.train_hyper['model_params']['version']
    ...
    while episode < args.train_hyper['train_params']['episodes']:
        ...
        replay_memory.append([state, reward, next_states, done])
